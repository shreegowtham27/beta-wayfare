            ...
            <Container>
                <Row className="justify-content-center align-items-center">
                    <Col md={6} className="p-3"> 
                        ...
                        <p style={{fontSize:'18px'}}>Experience the comfort of hassle-free modern and sustainable travel from bookings to check-ins. <br/><br/><span className="text-primary text-center font-weight-bolder d-block"><strong>Let&apos;s wayfare the world together.</strong></span></p>
                        <Link href="#contact">
